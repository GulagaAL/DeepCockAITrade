...
class Config:
    ...
    if backtest_start_str:
        ...
        # Только если переменная не задана — используем 3 недели назад
    ...
    DEEPSEEK_API_URL = os.getenv("DEEPSEEK_API_URL", "https://api.deepseek.com/v1/chat/completions")  # ✅ Убраны пробелы
