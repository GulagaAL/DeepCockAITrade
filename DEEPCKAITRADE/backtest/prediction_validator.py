...
class PredictionValidator:
    ...
    def calculate_accuracy_metrics(self, results):
        ...
        correct_predictions = len([r for r in results if r["accuracy"] == "correct"])
        incorrect_predictions = len([r for r in results if r["accuracy"] == "incorrect"])
        partial_predictions = len([r for r in results if r["accuracy"] == "partial"])
    ...
    def _calculate_precision(self, results, action_type):
        ...
        correct = len([r for r in relevant_results if r["accuracy"] == "correct"])
